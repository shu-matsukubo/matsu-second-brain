...
4. [Codex cloud の実行環境を設定する](<Codex cloud の実行環境を設定する.md>) に従い、依存関係、ツール、環境変数、シークレット、セットアップ手順を用意する。
...
- [Codex cloud の実行環境を設定する](<Codex cloud の実行環境を設定する.md>): クラウドタスクを再現可能にする依存関係、環境変数、シークレット、セットアップを確認する。
