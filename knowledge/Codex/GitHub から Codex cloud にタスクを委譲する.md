...
4. [Codex cloud の実行環境を設定する](<../01-facts/Codex/Codex cloud の実行環境を設定する.md>) に従い、依存関係、ツール、環境変数、シークレット、セットアップ手順を用意する。
...
- [Codex cloud の実行環境を設定する](<../01-facts/Codex/Codex cloud の実行環境を設定する.md>): クラウドタスクを再現可能にする依存関係、環境変数、シークレット、セットアップを確認する。
- [AIへの依頼は実装結果とともに保存する](<../02-principles/開発プロセス/AIへの依頼は実装結果とともに保存する.md>): 委譲したタスクを実装結果と対応づけ、再利用できる作業資産として残す。
